...
function conseguirEntrada($conexion, $id){
    $sql = "SELECT e.*, c.nombre AS 'categoria', CONCAT(u.nombre,' ',u.apellidos) AS usuario FROM entradas AS e INNER JOIN categorias AS c ON
    e.categoria_id = c.id INNER JOIN usuarios AS u ON e.usuario_id = u.id  WHERE e.id = $id;";
